        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                ...
                <div class="md-form mb-3">
                    <input type="texto" name="nombre" class="form-control validate" placeholder="Nombre..." required>
                </div>
                ...
                <div class="form-row mb-3">
                    <div class="col">
                        <div class="input-group">
                            ...
                            <input type="number" step="0.1" min="0" value="" name="costo" class="form-control validate" required>
                        </div>
                    ...
                    <div class="col">
                        <div class="input-group">
                            ...
                            <input type="number" step="0.1" min="0" value="" name="precio" class="form-control validate" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="input-group">
                        ...
                        <input type="number" min="0" name="cantidad" class="form-control validate" required>
                    </div>
                </div>
